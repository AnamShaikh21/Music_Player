...
class MainWindow(QMainWindow):
	...
	def homeScreen(self):
		self.setWindowTitle('PyQt5 Music Player by Anam Shaikh')
	...
	def addControls(self):
		...
		volumeDescBtn = QPushButton('Vol (-)')#Decrease Volume
		volumeIncBtn = QPushButton('Vol (+)')	#Increase Volume
	...
	def displaySongInfo(self):
		...
		infoBox.setWindowTitle('Song Information')
